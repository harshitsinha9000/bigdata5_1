...
public class Driver42 {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		job.setPartitionerClass(Partitioner52.class);
		job.setCombinerClass(Reducer42.class);
		...
		*/
		...
		if(success)
		{
			...
			job2.setPartitionerClass(Partitioner52.class);
			job2.setCombinerClass(Reducer421.class);
